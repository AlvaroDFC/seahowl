...
| [seahowl.fluid](fluid.md) | Fluid-related classes and utilities (aero/hydro). |
| [seahowl.fluid.aero](aero.md) | Aerodynamic load computation such as Blade Element Momentum Theory (BEMT). |
| [seahowl.fluid.hydro](hydro.md) | Hydrodynamic forces on substructures using Morison equations and potential flow. |
