...
.. csv-table:: Battery global parameters & variables
...
The main input file (or *command* file) of LiBat3d is a JSON file, which can be named arbitrarily (e.g., 'cmd.json'
